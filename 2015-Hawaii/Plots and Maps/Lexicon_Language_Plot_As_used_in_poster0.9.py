...
#3	14	7	Other Archived Endangered --- Green Circles<img src="../Responses-map.png" alt="Responses-map" width="3037" height="1646" />
...
red_patch = mpatches.Patch(color='red', label='Endangered Resources')
green_patch = mpatches.Patch(color='green', label='Archived Resources')
